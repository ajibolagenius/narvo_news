...
2. Add `.env.example` (backend and frontend) listing all required variables: `SUPABASE_URL`, `SUPABASE_ANON_KEY`, `MONGO_URL`, `DB_NAME`, `EMERGENT_LLM_KEY`, `REACT_APP_BACKEND_URL`, etc., with short comments. Do not commit real secrets.
