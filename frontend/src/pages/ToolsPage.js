...
const TOOL_CATEGORIES = [
  ...
  },
  {
    title: 'AI_SERVICES',
    tools: [
      { name: 'Google Gemini', desc: 'AI narrative generation & translation', url: 'https://deepmind.google/technologies/gemini/', tag: 'LLM' },
      { name: 'OpenAI TTS', desc: 'Text-to-speech broadcast voices', url: 'https://platform.openai.com/docs/guides/text-to-speech', tag: 'AUDIO' },
