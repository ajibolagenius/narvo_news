...
const OfflinePage = () => {
  ...
  return (
    <main className="flex-1 overflow-y-auto overflow-x-hidden custom-scroll p-4 md:p-10 space-y-8 md:space-y-12 max-w-7xl mx-auto w-full pb-32 md:pb-10 min-h-0" data-testid="offline-page">
      {/* Storage Header */}
