...
async function main() {
  ...
  try {
    ...
    await pageWide.goto(`${BASE_URL}/dashboard`, { waitUntil: 'networkidle', timeout: 20000 }).catch(() => pageWide.goto(`${BASE_URL}/`, { waitUntil: 'domcontentloaded', timeout: 15000 }));
    ...
    await pageMobile.goto(`${BASE_URL}/dashboard`, { waitUntil: 'networkidle', timeout: 20000 }).catch(() => pageMobile.goto(`${BASE_URL}/`, { waitUntil: 'domcontentloaded', timeout: 15000 }));
    await new Promise((r) => setTimeout(r, WAIT_MS));
